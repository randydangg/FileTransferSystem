...
public class Receiver extends javax.swing.JFrame{
	...
	private int sender_port, receiver_port, ackCount = 0, connection_type = 1;	//default is reliable connection
...
//                    .addComponent(mdsInput, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	private void transferReliable() throws SocketException {
		...
		try {
			datagramSocket2.receive(receive_init);
...
//		DatagramSocket datagramSocket2 = new DatagramSocket(receiver_port);
